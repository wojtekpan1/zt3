        ...
        <div className="desktop-4 screen">
          ...
          <div className="flex-row">
            ...
            <p className="a-o-o-a-o-o-a inputdefault">
              ...
              <span className="span3 inter-normal-electric-violet-24px">{spanText4}</span>
            </p>
          </div>
          ...
          <div className="overlap-group-container">
            ...
            <div className="overlap-group">
              ...
              <p className="look-by-symptom-cate inter-bold-black-20px">{lookBySymptomCate}</p>
            </div>
          </div>
          <div className="overlap-group3">
            <p className="please-note-catalys inter-bold-black-14px">
              <span className="inter-bold-black-14px">{spanText10}</span>
              <span className="span1 inputdefault">{spanText11}</span>
            </p>
          </div>
        </div>
      </div>

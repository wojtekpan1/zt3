      ...
      <div className="container-center-horizontal">
        <div className="desktop-1 screen">
          ...
          <div className="overlap-group2-1">
            ...
            <h1 className="title headingh3">{title}</h1>
          </div>
          ...
          <div className="flex-row-2">
            ...
            <p className="a-o-o-a-o-o-a-1 inputdefault">
              ...
              <span className="span3-1 inter-normal-electric-violet-24px">{spanText4}</span>
            </p>
          </div>
          ...
          <div className="overlap-group-container-1">
            ...
            <div className="overlap-group-1">
              ...
              <p className="look-by-symptom-cate-1 inter-bold-black-20px">{lookBySymptomCate}</p>
            </div>
          </div>
          <div className="overlap-group4">
            <p className="please-note-catalys-1 inter-bold-black-14px">
              <span className="inter-bold-black-14px">{spanText10}</span>
              <span className="span1-1 inputdefault">{spanText11}</span>
            </p>
          </div>
        </div>
      </div>
